...
import MChess from './models/MChess'
...
class Chess extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      chess: new MChess({ id: 0 })
    }
    this.onChangeChess = this.onChangeChess.bind(this);
  }
  onChangeChess(value, key) {
    let p = this.state.chess
      ...
      <Col xs="12" md="10" lg="10" style={style.col}>
        <Row style={style.col_row} >
          <Col xs="12" md="7" lg="7" style={style.col_center}>
            <CardTest
              tipo="chess"
              titulo="Problema: Chess"
              number={2}
              inp="input2"
              model={this.state.chess}
              onChangeModel={this.onChangeChess} />
          </Col>
          <Col xs="12" md="5" lg="5">
            <CardCode name_problem="Chess" code={codes} type="chess" />
          </Col>
        </Row>
      </Col>
    </Row>
